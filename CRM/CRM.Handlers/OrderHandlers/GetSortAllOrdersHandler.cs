...
{
    public class GetSortAllOrdersHandler : IRequestHandler<GetFilteredAndSortAllRequest<OrderResponse>, TableData<OrderResponse>>
    {
        private readonly AppDbContext _context;
        private readonly IMapper _mapper;
        private readonly ICurrentUser _currentUser;

        public GetSortAllOrdersHandler(AppDbContext context, IMapper mapper, ICurrentUser currentUser)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<TableData<OrderResponse>> Handle(GetFilteredAndSortAllRequest<OrderResponse> request, CancellationToken cancellationToken)
        {
